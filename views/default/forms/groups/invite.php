<?php
	...
	// add users to subsite
	if(elgg_is_admin_logged_in() && subsite_manager_on_subsite()){
		$form_data .= "<div>";
		$form_data .= "<input type='checkbox' name='subsite_manager_add_users' value='yes' />";
		$form_data .= "&nbsp;" . elgg_echo("subsite_manager:group:invite:add_users_to_site");
		$form_data .= "</div>";
	}
