...
function elgg_get_metastring_based_objects($options) {
	...
	// SUBSITE MANAGER 2.0: add a hook to allow subsite manager to expand options with metadata site_guids
	$options = elgg_trigger_plugin_hook("metastring:objects:get", $options['metastring_type'], $options, $options);
