...
function datalist_get($name) {
	...
	$query = "SELECT * from {$CONFIG->dbprefix}datalists WHERE name not LIKE 'sc_%'";
	
	if(isset($CONFIG->site_guid)){
		// only fetch useful sc data
		$query .= " OR name LIKE 'sc_%_" . $CONFIG->site_guid . "'";
	}
