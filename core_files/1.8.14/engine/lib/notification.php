	...
	if ($object instanceof ElggEntity) {
		...
		if (isset($CONFIG->register_objects[$object_type][$object_subtype])) {
			...
			foreach ($NOTIFICATION_HANDLERS as $method => $foo) {
				...
				if($user_options = elgg_trigger_plugin_hook("interested_users:options", "notify:" . $method, array("entity" => $object, "options" => $user_options), $user_options)){
					$interested_users = elgg_get_entities_from_relationship($user_options);
