...
$english = array(
	...
	'admin:administer_utilities:move_group' => "Move group content",
	'subsite_manager:admin:move_group:explanation' => "This tool allows subsite admins to move content easily between groups. WARNING! Use this tool with caution because merged content cannot be unmerged.",
	'subsite_manager:admin:move_group:from_to_same' => "From and to cannot be the same group.",
	'subsite_manager:admin:move_group:from' => "From",
	'subsite_manager:admin:move_group:to' => "To",
	'subsite_manager:admin:move_group:move' => "Move",
	'subsite_manager:admin:move_group:success' => "Moved content succesfully.",
	'subsite_manager:admin:move_group:preview' => "Preview",
	'subsite_manager:admin:move_group:move_entity' => "Move entity",
	'subsite_manager:admin:move_group:permission_of' => "Permission of",
	'subsite_manager:admin:move_group:annotation' => "Annotation",
	'subsite_manager:admin:move_group:on' => "on",
	'subsite_manager:admin:move_group:scheduled' => "Tasks scheduled (max 1000)",
	'subsite_manager:admin:move_group:no_items' => "No items scheduled.",
